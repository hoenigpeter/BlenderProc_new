...
#python rerun.py run examples/datasets/bop_challenge/main_keypose_transparent.py ../datasets resources/cc_textures /hdd/datasets_bop/keypose --num_scenes=1000
...
for obj in (target_bop_objs + itodd_dist_bop_objs + hb_dist_bop_objs):
